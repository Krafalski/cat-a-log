...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post cats_url, params: { cat: { age: @cat.age, bio: @cat.bio, color: @cat.color, image: @cat.image, name: @cat.name } }
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { age: @cat.age, bio: @cat.bio, color: @cat.color, image: @cat.image, name: @cat.name } }
